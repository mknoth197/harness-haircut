...
- **U2.** The package shall ship `templates/github-action.yml` documented in the README.
...
- [ ] `templates/github-action.yml` is valid YAML, runs `audit`, fails on non-zero exit.
